...
import com.psm.api.configuration.AsyncConfiguration;
...
public class TestService {
	...
	@Async
	public void asyncTest(ApiServerListEntity apiserverInfo) {
		/* 해당 API서버가 삭제되었거나 소속 회사가 삭제된 경우 시행하지 않음 */
		logger.info("비동기 작동되나?!", Thread.currentThread().getName());
		System.out.println("비동기 작동되나?!" + Thread.currentThread().getName());
